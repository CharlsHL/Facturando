Public Class ctrlcliente
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        End If
    End Sub
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles factura.Click
    ...
    End Sub
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles moddatos.Click
